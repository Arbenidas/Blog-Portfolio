...
export async function netlifyAppEngineHandler(request: Request): Promise<Response> {
  ...
  // Block bot/scanner paths immediately — no Angular SSR needed
  ...
  // Angular SSR — if it fails, fall through to Netlify's static file serving
  try {
  ...
  // Fall through to Netlify's origin (serves pre-built static files like index.html)
  return context.next();
}
